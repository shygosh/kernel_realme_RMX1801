...
#if CONFIG_OPPO_BSP_SECCOM_PLATFORM == 6763 ||                                 \
	CONFIG_OPPO_BSP_SECCOM_PLATFORM == 6771 ||                             \
	CONFIG_OPPO_BSP_SECCOM_PLATFORM == 6779
#include <sec_boot_lib.h>
#elif CONFIG_OPPO_BSP_SECCOM_PLATFORM == 855 || CONFIG_OPPO_BSP_SECCOM_PLATFORM == 660
...
#if CONFIG_OPPO_BSP_SECCOM_PLATFORM == 855 || CONFIG_OPPO_BSP_SECCOM_PLATFORM == 660
// shygosh: add for platform 660
...
#if CONFIG_OPPO_BSP_SECCOM_PLATFORM == 660 ||                                  \
	CONFIG_OPPO_BSP_SECCOM_PLATFORM == 845 ||                              \
	CONFIG_OPPO_BSP_SECCOM_PLATFORM == 670 ||                              \
	CONFIG_OPPO_BSP_SECCOM_PLATFORM ==                                     \
		710 /* sdm660, sdm845, sdm670, sdm710 */
...
#elif CONFIG_OPPO_BSP_SECCOM_PLATFORM == 8953 ||                               \
	CONFIG_OPPO_BSP_SECCOM_PLATFORM == 8976 /* msm8953, 8976pro */
...
static secure_type_t get_secureType(void)
{
	...
	CONFIG_OPPO_BSP_SECCOM_PLATFORM == 845 ||                              \
	CONFIG_OPPO_BSP_SECCOM_PLATFORM == 670 ||                              \
	CONFIG_OPPO_BSP_SECCOM_PLATFORM == 710 ||                              \
	CONFIG_OPPO_BSP_SECCOM_PLATFORM ==                                     \
		855 /* sdm660, sdm845, sdm670, sdm710, sdm855 */
				     ...
				     size_t count, loff_t *offp)
{
	...
	local_count =
		(FUSE_VALUE_LEN - 1) < count ? (FUSE_VALUE_LEN - 1) : count;
				       ...
				       size_t count, loff_t *off)
{
	...
	if (get_secureType() == SECURE_BOOT_ON_STAGE_2 &&
		...
		secureSNBound_state =
			SECURE_DEVICE_SN_BOUND_OFF; /*secure stage2 devices not bind serial number*/
	} else {
		secureSNBound_state =
			SECURE_DEVICE_SN_BOUND_ON; /*secure stage2 devices bind serial number*/
	}
